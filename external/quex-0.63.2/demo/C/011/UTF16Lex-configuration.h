...
#ifndef __QUEX_INCLUDE_GUARD__ANALYZER__CONFIGURATION__QUEX___UTF16LEX
#define __QUEX_INCLUDE_GUARD__ANALYZER__CONFIGURATION__QUEX___UTF16LEX
...
#define QUEX_SETTING_VERSION           "0.63.2-pre"
#define QUEX_SETTING_BUILD_DATE        "Tue Jun 26 22:10:19 2012"
...
#   define __QUEX_SETTING_INITIAL_LEXER_MODE_ID    (QUEX_NAME(ModeID_X))
#endif
/* NOTE: QUEX_TYPE_TOKEN_ID is later on defined inside the token class header. */
#define    __QUEX_SETTING_TOKEN_ID_TERMINATION       ((QUEX_TYPE_TOKEN_ID)TKN_TERMINATION)
#define    __QUEX_SETTING_TOKEN_ID_UNINITIALIZED     ((QUEX_TYPE_TOKEN_ID)TKN_UNINITIALIZED)
#define    __QUEX_SETTING_TOKEN_ID_INDENT            ((QUEX_TYPE_TOKEN_ID)TKN_INDENT)
#define    __QUEX_SETTING_TOKEN_ID_DEDENT            ((QUEX_TYPE_TOKEN_ID)TKN_DEDENT)
#define    __QUEX_SETTING_TOKEN_ID_NODENT            ((QUEX_TYPE_TOKEN_ID)TKN_NODENT)
...
#   define QUEX_SETTING_CHARACTER_SIZE  2
#endif
#ifndef    QUEX_SETTING_CHARACTER_CODEC   
#   define QUEX_SETTING_CHARACTER_CODEC utf16
#endif
...
#   define QUEX_FUNCTION_PREFIX        quex_UTF16Lex_
#   define QUEX_FUNCTION_DEF_PREFIX    quex_UTF16Lex_
    /* In 'C' there are no namespaces, so namespaces are coded directly
     * into the type name. Both, global and local names are equal.       */
#   define QUEX_TYPE0_ANALYZER         struct quex_UTF16Lex_tag
#   define QUEX_TYPE_ANALYZER          struct quex_UTF16Lex_tag
#   define QUEX_NAME_COMPLETE_ANALYZER quex_UTF16Lex
#   define QUEX_TYPE_DERIVED_ANALYZER  struct quex_UTF16Lex_tag
...
#   define QUEX_NAMESPACE_MAIN         quex_UTF16Lex
...
#   define QUEX_NAME(NAME)             quex_UTF16Lex_ ## NAME
...
#   define QUEX_FUNCTION_PREFIX_BACKUP       quex_UTF16Lex_
#   define QUEX_FUNCTION_DEF_PREFIX_BACKUP   quex_UTF16Lex_
...
#   define QUEX_FUNCTION_PREFIX        que::
     ...
     * and token.                                                        */
#   define QUEX_TYPE0_ANALYZER         UTF16Lex
#   define QUEX_TYPE_ANALYZER          que::UTF16Lex
#   define QUEX_NAME_COMPLETE_ANALYZER que::UTF16Lex
#   define QUEX_TYPE_DERIVED_ANALYZER  UTF16Lex
...
#   define QUEX_NAME(NAME)             UTF16Lex_ ## NAME
#   define QUEX_NAME_TOKEN(NAME)       Token_ ## NAME
#   define QUEX_MEMBER(NAME)           UTF16Lex::NAME                
    /* When creating a 'shared token class', macros are temporarily redefined.
     * This happens to generate converters in the token's namespace. After 
     * that, the original macros need to be restored. Thus: Backup!          */  
...
#endif /* __QUEX_INCLUDE_GUARD__ANALYZER__CONFIGURATION__QUEX___UTF16LEX */
