...
#   line 122 "/home/fschaef/prj/quex/trunk/quex/code_base/token/CDefault.qx"

       self.number = N;
   

#   line 2383 "UTF16Lex.c"
...
#   line 130 "/home/fschaef/prj/quex/trunk/quex/code_base/token/CDefault.qx"
        ...
        quex_Token_pretty_char_text(quex_Token* me, char*   buffer, size_t  BufferSize) 
        {
            ...
            QUEX_CONVERTER_STRING(utf16,char)(&source, SourceEnd, &drain, DrainEnd);
            return buffer;
        }
...
#       if ! defined(__QUEX_OPTION_WCHAR_T_DISABLED)
        ...
        quex_Token_pretty_wchar_text(quex_Token* me, wchar_t*  buffer, size_t    BufferSize) 
        {
            ...
            QUEX_CONVERTER_STRING(utf16,wchar)(&source, SourceEnd, &drain, DrainEnd);
            return buffer;
        }
#       endif
